...
from backend.semantic_parsing.ingredient_parser import IngredientKnowledgeGraph
...
def spacy_parse_ingredient(nlp, raw: str) -> dict:
    ...
    if qty_parts:
        from backend.semantic_parsing.ingredient_parser import _parse_qty
        total = 0.0
...
class AdvancedNERParser:
    ...
    def parse(self, raw: str) -> dict:
        if self.backend == "spacy" and self._nlp:
            ...
            from backend.semantic_parsing.ingredient_parser import parse_quantity_unit, extract_modifiers
